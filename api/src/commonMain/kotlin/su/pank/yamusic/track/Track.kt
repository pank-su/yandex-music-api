...
import su.pank.yamusic.track.model.DerivedColors
import su.pank.yamusic.track.model.TrackDTO
import su.pank.yamusic.track.model.TrackSharingFlag
import track.model.*
import track.model.downloadInfo.Codec
import track.model.downloadInfo.DownloadInfo

class Track(
    private val client: YaMusicClient,
    val id: String,
    val title: String,
...
fun TrackDTO.toTrack(client: YaMusicClient): Track = Track(
    client,
    id,
    title,
    available,
