...
import su.pank.yamusic.exceptions.SessionExpiredException
...
class YaMusicClient {
    ...
    // TODO: перенести все настройки в отдельный builder
     ...
     *
     */
    suspend fun init(init: YaMusicClient.() -> Unit) {
        this.init()
        try {
            me = account.status()
