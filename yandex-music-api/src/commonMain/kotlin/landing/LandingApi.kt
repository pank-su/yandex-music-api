...
class LandingApi(private val client: Client) {
     ...
     * @see BlockType
     */
    suspend operator fun invoke(vararg blocks: BlockType = BlockType.entries.toTypedArray()): Landing = getBlocks(*blocks)
